...
{
	// front
	{.a = 1, .b = 2, .c = 3, .a_uv = { 0,1 }, .b_uv = { 0, 0 }, .c_uv = { 1, 0 }, .color = White },
	{.a = 1, .b = 3, .c = 4, .a_uv = { 0,1 }, .b_uv = { 1, 0 }, .c_uv = { 1, 1 }, .color = White },
	// rig ht
	{.a = 4, .b = 3, .c = 5, .a_uv = { 0,1 }, .b_uv = { 0, 0 }, .c_uv = { 1, 0 }, .color = White },
	{.a = 4, .b = 5, .c = 6, .a_uv = { 0,1 }, .b_uv = { 1, 0 }, .c_uv = { 1, 1 }, .color = White },
	// ba ck
	{.a = 6, .b = 5, .c = 7, .a_uv = { 0,1 }, .b_uv = { 0, 0 }, .c_uv = { 1, 0 }, .color = White },
	{.a = 6, .b = 7, .c = 8, .a_uv = { 0,1 }, .b_uv = { 1, 0 }, .c_uv = { 1, 1 }, .color = White },
	// le ft
	{.a = 8, .b = 7, .c = 2, .a_uv = { 0,1 }, .b_uv = { 0, 0 }, .c_uv = { 1, 0 }, .color = White },
	{.a = 8, .b = 2, .c = 1, .a_uv = { 0,1 }, .b_uv = { 1, 0 }, .c_uv = { 1, 1 }, .color = White },
	// t op
	{.a = 2, .b = 7, .c = 5, .a_uv = { 0,1 }, .b_uv = { 0, 0 }, .c_uv = { 1, 0 }, .color = White },
	{.a = 2, .b = 5, .c = 3, .a_uv = { 0,1 }, .b_uv = { 1, 0 }, .c_uv = { 1, 1 }, .color = White },
	// bott om
	{.a = 6, .b = 8, .c = 1, .a_uv = { 0,1 }, .b_uv = { 0, 0 }, .c_uv = { 1, 0 }, .color = White },
	{.a = 6, .b = 1, .c = 4, .a_uv = { 0,1 }, .b_uv = { 1, 0 }, .c_uv = { 1, 1 }, .color = White }
};
