...
{
    int x0 = triangle->points[0].x; int y0 = triangle->points[0].y;
    int x1 = triangle->points[1].x; int y1 = triangle->points[1].y;
    int x2 = triangle->points[2].x; int y2 = triangle->points[2].y;
